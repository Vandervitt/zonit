...
export const PLANS: Record<PlanId, PlanConfig> = {
  ...
  starter: {
    id: "starter", label: "Starter", priceText: "$29.99/mo", color: "blue",
  ...
  pro: {
    id: "pro", label: "Pro", priceText: "$79.99/mo", color: "violet", highlight: true,
  ...
  agency: {
    id: "agency", label: "Agency", priceText: "$199.99/mo", color: "amber",
