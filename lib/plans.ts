...
export const PLANS: Record<PlanId, PlanConfig> = {
  free: {
    ...
    hasWatermark: true, allTemplates: true, advancedTracking: false, antiBan: false,
  ...
  pro: {
    ...
    hasWatermark: false, allTemplates: true, advancedTracking: true, antiBan: true,
  ...
  agency: {
    ...
    highlights: ["无限落地页 + 无限域名", "AI 生成额度提升至 300 次/月"],
  },
};
