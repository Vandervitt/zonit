...
export const radiantGlowBeautyDraft: LandingPageDraft = {
  ...
  // 收的是同一件事（skincare consultation），只是换个落点，故文案与 CTA 主题保持一致。
  leadForm: {
    enabled: true,
    title: "Prefer email? Get your skincare consultation here",
    description:
      "Not on WhatsApp, or would rather not message? Fill this in and a skincare specialist will send your skincare consultation by email instead. Same free advice, no obligation to buy anything.",
    submitText: "Send me my skincare consultation",
    successMessage:
      "Thanks — a skincare specialist will email you your skincare consultation shortly. Check your spam folder if it hasn't arrived.",
    fields: {
      ...
      message: {
        enabled: true,
        required: true,
        label: "Your skin type, concerns, and current routine",
      },
    },
  },
