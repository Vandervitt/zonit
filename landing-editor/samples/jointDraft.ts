...
export const jointDraft: LandingPageDraft = {
  ...
  // 收的是同一件事（mobility check），只是换个落点，故文案与 CTA 主题保持一致。
  leadForm: {
    enabled: true,
    title: "Prefer email? Get your mobility check here",
    description:
      "Not on WhatsApp, or would rather not message? Fill this in and a mobility adviser will send your mobility check by email instead. Same free advice, no obligation to buy anything.",
    submitText: "Send me my mobility check",
    successMessage:
      "Thanks — a mobility adviser will email you your mobility check shortly. Check your spam folder if it hasn't arrived.",
    fields: {
      ...
      message: {
        enabled: true,
        required: true,
        label: "Which joints bother you and when it's worst during the day",
      },
    },
  },
