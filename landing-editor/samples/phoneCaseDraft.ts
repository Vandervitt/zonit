...
export const phoneCaseDraft: LandingPageDraft = {
  ...
  // 收的是同一件事（case match），只是换个落点，故文案与 CTA 主题保持一致。
  leadForm: {
    enabled: true,
    title: "Prefer email? Get your case match here",
    description:
      "Not on WhatsApp, or would rather not message? Fill this in and our product team will send your case match by email instead. Same free advice, no obligation to buy anything.",
    submitText: "Send me my case match",
    successMessage:
      "Thanks — our product team will email you your case match shortly. Check your spam folder if it hasn't arrived.",
    fields: {
      ...
      message: {
        enabled: true,
        required: true,
        label: "Your exact phone model and how rough you are with it",
      },
    },
  },
