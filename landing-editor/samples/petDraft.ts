...
export const petDraft: LandingPageDraft = {
  ...
  // 收的是同一件事（pet advice），只是换个落点，故文案与 CTA 主题保持一致。
  leadForm: {
    enabled: true,
    title: "Prefer email? Get your pet advice here",
    description:
      "Not on WhatsApp, or would rather not message? Fill this in and our pet care team will send your pet advice by email instead. Same free advice, no obligation to buy anything.",
    submitText: "Send me my pet advice",
    successMessage:
      "Thanks — our pet care team will email you your pet advice shortly. Check your spam folder if it hasn't arrived.",
    fields: {
      ...
      message: {
        enabled: true,
        required: true,
        label: "Your pet's breed, age, and what you need help with",
      },
    },
  },
