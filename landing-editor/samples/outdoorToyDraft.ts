...
export const outdoorToyDraft: LandingPageDraft = {
  ...
  // 收的是同一件事（play match），只是换个落点，故文案与 CTA 主题保持一致。
  leadForm: {
    enabled: true,
    title: "Prefer email? Get your play match here",
    description:
      "Not on WhatsApp, or would rather not message? Fill this in and our play team will send your play match by email instead. Same free advice, no obligation to buy anything.",
    submitText: "Send me my play match",
    successMessage:
      "Thanks — our play team will email you your play match shortly. Check your spam folder if it hasn't arrived.",
    fields: {
      ...
      message: {
        enabled: true,
        required: true,
        label: "Your child's age and how much outdoor space you have",
      },
    },
  },
