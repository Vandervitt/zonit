...
export const TEMPLATES: TemplateMeta[] = [
  {
    ...
    seoIntro: {
      ...
      zh: "护肤访客带着一个具体困扰而来，心里只有一个问题：你是否足够理解它，值得他回一句话。Aurae 以困扰而非产品开场，用「免费肤质分析」给出开口的理由，再以成分讲解、未修图的前后对比与用户原声把信任垫起来。卖到海外时这套结构尤其吃香：气候与肤质分布随市场变化，一次评估比任何通用卖点都更能接住差异。适合通过 Meta / TikTok 投放护肤、抗老、祛痘类产品的独立站与代运营团队，想要「重咨询、轻交易」的获客承接页。",
    },
  ...
  // ===== 第一梯队 · 美妆个护 =====
  {
    ...
    seoIntro: {
      ...
      zh: "色号是决定彩妆购买的那个疑虑，而它由真人解答远比一张色卡表有效——不同市场的肤色分布本就不同，一套在本土够用的色卡，换个国家就覆盖不住。Velvet Studio 以「免费色号匹配 + 妆容方案」开场，用上妆效果、覆盖多种肤色的色卡墙与真实用户妆容，让这个承诺显得可信。适合口红、粉底、眼影等彩妆品类通过 Meta / TikTok 投放的独立站与红人团队。",
    },
  ...
  },
  {
    ...
    seoIntro: {
      ...
      zh: "家用美容仪靠原理而不是靠承诺——效果因人差异太大，不适合写在公开页面上。Lumio 讲清仪器怎么工作、演示护理流程，并以聊天里的「免费护理方案」完成转化——个体效果该在那里被负责任地讨论。做海外市场还要多答一层：电压与插头制式、以及保修在当地怎么执行。适合射频、微电流、美容仪类高客单产品的品牌与代运营团队承接投放。",
    },
  ...
  },
  {
    ...
    seoIntro: {
      ...
      zh: "在脱发这个类目里，最有说服力的写法恰恰是最不合规的那种，而各国对功效表述的尺度还不一样——本土能写的话，换个市场可能就越界。所以 Rooted 刻意只谈头皮状况与日常护理，承担转化的是免费头皮评估：它把效果讨论移进私下回复，逐个案例、也逐个市场地确认。适合生发精华、防脱洗护类产品的品牌与代运营团队。",
    },
  ...
  },
  {
    ...
    seoIntro: {
      ...
      zh: "拦住购买的是「合不合身」，而大码顾客已经被尺码表辜负过太多次——各国码制本就不统一，跨市场买大码更是重灾区。Curvana 先讲合身、后讲穿搭，用同一件衣服在真正不同体型上的实穿图并标明所穿尺码，再以「免费合身建议」完成转化。适合大码女装、包容性时尚品牌的独立站与代运营团队。",
    },
  ...
  },
  {
    ...
    seoIntro: {
      ...
      zh: "好看带来点击，性能打消疑虑——Strive Move 用的就是这个顺序。面料说法具体到可以被验证，而「免费选款」把尺码问题变成训练场景问题：更容易答好，也更能看清这个买家。这在跨市场经营时额外有用——各地体型分布与码制都不同，问训练方式比问尺码更不容易问错。适合瑜伽服、运动内衣、健身服饰品牌的独立站与代运营团队。",
    },
  ...
  },
  {
    ...
    seoIntro: {
      ...
      zh: "贴身品类需要坦率而不冒犯的表达，所以 Sienne 页面上只讲面料与剪裁这些事实，把一切与身材有关的话题留给私下回复。上身效果与真实反馈负责建立信任，「免费合身建议」负责转化。跨市场投放时这个分寸还要再收一档：各地对身材类广告的审核尺度差异很大。适合塑身衣、无痕内衣类品牌的独立站与红人团队。",
    },
  ...
  // ===== 第一梯队 · 3C 数码配件 =====
  {
    ...
    seoIntro: {
      ...
      zh: "兼容性是个是非题，所以 Shieldly 一上来就问机型，之后的一切都作为推荐来处理。带真实录像的防摔测试、材质细节与用户反馈，帮访客按自己真正的使用方式选对壳膜。做多个市场时机型问题会放大——各地主流机型与发布节奏并不同步，页面上的适配清单需要按市场分别维护。适合手机壳、钢化膜、镜头膜类配件的独立站与代运营团队。",
    },
  ...
  },
  {
    ...
    seoIntro: {
      ...
      zh: "参数会把大部分本来会买的人筛掉，所以 Voltway 先讲数字的含义——多久充满、能充几次、带不带得动笔电——把瓦数与协议细节放在下方。卖到其他市场时，插头制式、电压与当地认证（PSE、CE、UL 各管各的）必须写在页面上：这是买家不会问、但会因此放弃的那类问题。适合充电宝、氮化镓充电器、数据线类 3C 配件品牌与代运营团队。",
    },
  ...
  },
  {
    ...
    seoIntro: {
      ...
      zh: "音质在页面上没法演示，所以 Sonara 改从使用场景与佩戴切入：用在什么环境、通勤和通话表现如何、运动时会不会掉。「免费选购建议」接住的，正是参数表永远答不了的那个问题。跨市场还要多写一句蓝牙频段与语音助手在当地是否可用——不可用的功能写在页面上就是负资产。适合无线耳机、降噪耳机、音箱类 3C 品牌的独立站与代运营团队。",
    },
  ...
  },
  {
    ...
    seoIntro: {
      ...
      zh: "一块无法与访客手机配对的设备，多便宜都不会被买，所以 Pulse 把兼容性放进首屏。功能演示与续航说明完成说服，健康数据一律标注为仅供参考，绝不写成医疗监测。跨市场经营时兼容性还包括两件容易被忽略的事：网络频段，以及配套 App 在当地应用商店有没有上架。适合智能手表、手环类品牌的独立站与代运营团队。",
    },
  ...
  },
  {
    ...
    seoIntro: {
      ...
      zh: "几乎没人只买一件智能家居设备——他们买的是一套能用起来的组合，所以 Nestly 的转化点是「免费组网方案」而不是某个产品。分场景演示、明确写出的生态兼容与安装说明，先把设备如何协同讲清楚。卖到其他市场时，电压制式与生态服务在当地是否开通，需要和兼容性写在同一处。适合智能灯具、门锁、传感器等智能家居品牌的独立站与代运营团队。",
    },
  ...
  // ===== 第一梯队 · 家居家纺 =====
  {
    ...
    seoIntro: {
      ...
      zh: "「免费收纳方案」的存在是为了换来一张真实空间的照片——那是唯一能让推荐变得笃定的方式，跨市场时更是如此：各地户型与柜体尺寸标准都不一样，照片比任何尺寸表都可靠。Tidely 用诚实的房间前后对比配合分场景应用，把访客自己的空间焦虑导向一次对话。适合收纳盒、置物架、整理神器类家居品牌的独立站与代运营团队。",
    },
  ...
  },
  {
    ...
    seoIntro: {
      ...
      zh: "厨房用具是为了某道菜而买的，不是为了参数，所以 Cucina 先问访客常做什么菜，再据此推荐。使用演示与成品效果负责勾人，灶具与电器兼容信息则明确写在页面上——这一项在跨市场经营时最容易翻车：电压不同、明火与电磁的普及度也不同，一口在买家灶上用不了的锅就是一次退货。适合厨房小工具、烘焙器具、创意餐厨类品牌的独立站与红人团队。",
    },
  ...
  },
  {
    ...
    seoIntro: {
      ...
      zh: "品种、年龄和体重对推荐结果的影响大过任何产品参数，所以 Pawsly 先问宠物、后问产品。萌宠实拍与真实铲屎官口碑营造情感共鸣，健康问题一律引向兽医，不在页面上作答。做海外市场时还要留意：宠物食品与用品的准入规则各国差别很大，能不能卖过去要先于怎么卖清楚。适合宠物零食、玩具、护理用品类品牌的独立站与代运营团队。",
    },
  ...
  },
  {
    ...
    seoIntro: {
      ...
      zh: "园艺需求随季节剧烈波动，而跨市场经营时这件事会变得更棘手——南北半球的季节相反，气候带更是完全不同。所以 Verda 保持「庭院规划」这个钩子不变，只轮换规划的主题；庭院实景与种植效果营造向往感，规划对话则收集气候、面积、日照与愿意投入的时间，这些才让推荐有用。适合园艺工具、户外植栽、庭院装饰类品牌的独立站与代运营团队。",
    },
  ...
  },
  {
    ...
    seoIntro: {
      ...
      zh: "床品的评判标准是「睡起来什么感觉」，不是标签上的数字，所以 Dwell 先讲控温、手感和洗过十次之后的表现。卧室场景与真实睡感反馈完成舒适度说服，而关于床型的对话通常一次就能问出两三处缺口——跨市场时这一步不能省：各国床垫尺寸标准不通用，问清床型比给一张换算表管用。适合四件套、被芯、枕头类家纺品牌的独立站与代运营团队。",
    },
  ...
  // ===== 第一梯队 · 健康保健品 =====
  {
    ...
    seoIntro: {
      ...
      zh: "保健品是「卖到另一个市场」先是监管问题、其次才是营销问题的类目：允许的成分与表述各国不同，一张在本土合规的页面隔条国界就可能违法。所以 Vitae 改走机制与可信度的路线——成分讲解与使用场景撑起页面，限定语放在每处表述旁边而不是堆在页脚，「免费营养评估」则把个体沟通移出公开页面，也移出了外国监管者会读到的范围。适合维生素、膳食补充类品牌在严监管市场做合规获客的独立站与代运营团队。",
    },
  ...
  },
  {
    ...
    seoIntro: {
      ...
      zh: "Balance 卖的是「习惯」而不是「结果」，因为这个类目里所有结果导向的说法，不是无法举证就是无法过审——而各市场对减重类广告的限制严格程度还不一样，按最严的那个市场写才安全。饮食与生活习惯科普加上用户经验分享撑起页面，全页不作任何减重承诺，也不放身材变化对比图。适合代餐、膳食纤维、体重管理类品牌做合规投放承接的独立站与代运营团队。",
    },
  ...
  },
  {
    ...
    seoIntro: {
      ...
      zh: "Lull 谈的是作息与环境而不是病症——睡眠类页面通常就是在这里越界的。睡前习惯、光线与时间安排承担科普，「免费睡眠评估」则收集那四项让回复值得一读的具体信息。跨市场尤其要当心成分：褪黑素这类原料在部分国家按处方药管理，同一款产品在两个市场能说的话完全不同。适合助眠软糖、香氛、睡眠好物类品牌在严监管市场做合规获客的独立站与代运营团队。",
    },
  ...
  },
  {
    ...
    seoIntro: {
      ...
      zh: "这个受众偏年长，所以字号、对比度和显眼的电话入口不再是打磨细节，而是转化因素。Mobil 只谈活动能力与日常，不指名疾病——用日常活动科普与用户经验完成说服，不主张医疗效果。这条底线在跨市场时只能更保守：各国对成分与功效表述的许可范围不一致，取交集才不会踩线。适合关节养护、运动恢复类保健品牌做合规投放承接的独立站与代运营团队。",
    },
  ...
  },
  {
    ...
    seoIntro: {
      ...
      zh: "这些话题离受监管的医疗范畴最近，其中几项本身就是广告受限类目，而受限的具体范围还因市场而异。Aria 把话题直白讲清、把宣称收窄，每处表述旁边都带限定语，并把效果讨论移进私下的健康评估里——这既是合规上的稳妥做法，也让同一张页面能投进标准不同的多个市场。适合女性膳食补充、经期与孕期养护类品牌做合规获客的独立站与代运营团队。",
    },
  ...
  // ===== 第一梯队 · 玩具母婴 =====
  {
    ...
    seoIntro: {
      ...
      zh: "在这里，点明「锻炼哪项能力、适合哪个年龄」才有说服力；「开发智力」则是家长和广告审核都已学会不信的说法。Sprout Play 把玩法演示与具体的发展益处、家长口碑放在一起，并以「按龄推荐」完成转化——一个问题就筛清了线索。卖到其他市场时记得写明玩具安全标准的名称：海外家长找的是 EN71 或 ASTM，而不是你手上那个他没听过的编号。适合早教玩具、STEM 积木类品牌的独立站与代运营团队。",
    },
  ...
  },
  {
    ...
    seoIntro: {
      ...
      zh: "感统玩具常因确诊需求而被购买，所以 Calmly 只描述玩具本身做了什么——材质、阻力、重复动作——不宣称它能应对某种状况。玩法演示与使用场景营造出这个类目承诺的平静感，而推荐对话对家长和成年买家同样成立。面向海外家长时，小零件与吞咽风险的检测标准要按当地通行的那套来写。适合解压玩具、感统训练类产品的独立站与红人团队。",
    },
  ...
  },
  {
    ...
    seoIntro: {
      ...
      zh: "家长在读任何一条卖点之前先确认安全，所以 Nido 把材质、认证与适用年龄放在产品图上方而不是下方。喂养场景与真实家长口碑建立信任，而「处于哪个阶段」这个问题既筛选了线索，也告诉你下一次需求什么时候到。跨市场时认证要写对市场：入口材料的标准各国不同，海外家长只认他们熟悉的那一个。适合奶瓶、辅食工具、喂养用品类品牌的独立站与代运营团队。",
    },
  ...
  },
  {
    ...
    seoIntro: {
      ...
      zh: "孕产文案要有用，又不能默认孕程会如何发展，所以 Bloom 只谈舒适与实用，回避任何暗示健康作用的表述。按孕期阶段推荐，让访客有理由说出自己所处的阶段——这是这个类目里最不冒犯的筛选问题。投放到不同市场时还要再核一遍尺度：各地对孕产类广告的审核宽严差别不小。适合孕妇装、护理与孕产周边类品牌的独立站与代运营团队。",
    },
  ...
  },
  {
    ...
    seoIntro: {
      ...
      zh: "户外玩耍有跌落风险，所以 Romp 把看护提示、承重与身高限制、场地要求放在谨慎家长真正看得到的位置。玩法演示与户外场景营造活力，活动建议随季节轮换——做多个市场时这一点要按半球分开排，南北半球的旺季正好错开，同一份日历用两次必然踩空。适合滑板车、平衡车、户外运动玩具类品牌的独立站与代运营团队。",
    },
  ...
  // ---------------------------------------------------------------------
  {
    ...
    seoIntro: {
      ...
      zh: "采购团队要先判断你是不是可信的供应商，才肯花一次回复，所以 Meridian 把「能力」前置，而不是先讲品牌故事。页内询价表单收集规格、数量、目的地与时间，让第一次回复就能是报价——其中「目的地」在跨境采购里决定认证、单证、关税与交期，缺了它的报价只是猜测。产能线、分阶段质检与出口单证回答采购真正关心的问题，「先签 NDA」则打消图纸外泄这个最大顾虑。适合 OEM 工厂、贴牌供应商与采购代理投放 Meta / LinkedIn，承接需要规格与数量的高质量线索。",
    },
  ...
  },
  {
    ...
    seoIntro: {
      ...
      zh: "30 分钟的真人演示成本很高，所以 Flowlane 用一张简短的资格表单而不是开放日程来承接——几个字段省下的销售时间，多过它损失的提交量，而且跨时区时它还顺手解决了排期：表单能收下对方所在时区，开放日程不能。成效数据、安全合规徽章与「不追着推销」的明确承诺，回应买家交出日历前最在意的两件事：是否靠谱、会不会被骚扰。适合运营、物流与流程类 SaaS 团队做付费投放，承接合格的演示预约而非泛泛订阅。",
    },
  ...
  },
  {
    ...
    seoIntro: {
      ...
      zh: "教育决策周期长、金额大，而且拍板的往往不是学生本人，所以 Northbridge 围绕一个低门槛的第一步来搭：免费个性化学习计划。这里的跨境方向和实体商品相反——学生要出去，于是入学时间、签证节点与学历认可度都从行政细节变成了转化问题。选校清单、入学要求与真实时间线取代宣传册话术，并明确写出「无人能保证录取」。适合留学中介与语言学校投放 Meta / TikTok，承接愿意真正开口咨询的学生线索。",
    },
  ...
  },
  {
    ...
    seoIntro: {
      ...
      zh: "移民业务按定义就是跨境的：客户在一个国家，结果发生在另一个国家——这决定了页面上一切实务安排，客户走不进办公室，时差让电话接案不可靠，案件事实只能以文件形式送达。所以 Vantage 直接回答「这家机构办不办我这类案子」，把「我的案子有没有可能」转化成一次评估：页内表单只收集案件事实、不给结论，同时明确声明「无人能保证获批」「提交表单不构成委托关系」。适合持牌顾问与律所在高审查品类投放——在这里，不作承诺的合规文案就是账号能否活下来的分界线。",
    },
  ...
  {
    id: "family-law",
    name: "Harborline Family Law",
    industry: { en: "Legal / Family law", zh: "法律 / 家事法" },
    tagline: { en: "Family law consultation page — clients write the situation, a solicitor reads it first.", zh: "家事法咨询落地页，当事人书面陈述，律师先看事实再回电。" },
    seoIntro: {
      en: "People contacting a family solicitor are rarely ready to say it out loud, so Harborline converts on a written first consultation rather than a callback. The page explains which route actually applies — mediation, negotiated agreement, or court — gives a realistic timeline, and states plainly where a position is weak, with an explicit no-guarantee line and a confidentiality promise from the first message. Built for family law practices advertising in a regulated category where testimonials must be anonymised and any promise of an outcome is both a compliance problem and a credibility one.",
      zh: "联系家事律师的人往往开不了口，所以 Harborline 的转化点是一次书面首诊，而不是回拨预约。页面讲清真正适用的是哪条路——调解、协商还是诉讼，给出真实时间线，并直白说出当事人的哪一部分主张站不住；同时明确写出「无人能保证结果」以及从第一条消息起即保密。适合在受监管品类投放的家事律所——在这里，评价必须匿名化，而任何结果承诺既是合规问题，也是可信度问题。",
    },
    thumbnail: "https://images.unsplash.com/photo-1758518731462-d091b0b4ed0d?auto=format&fit=crop&w=1600&q=80",
    tier: "t2",
    tags: { category: "legal", subcategory: "family-law", archetype: "consult", conversion: ["form", "phone"], risk: "high", tone: "rational" },
  },
  {
    id: "windows-doors",
    name: "Northgate Windows & Doors",
    industry: { en: "Home improvement / Windows & doors", zh: "家装 / 门窗更换" },
    tagline: { en: "Window replacement page — free survey, then a written quote that does not move.", zh: "门窗更换落地页，免费上门测量后出具不变价的书面报价。" },
    seoIntro: {
      en: "Nothing in window replacement can be quoted honestly from photographs, so Northgate is built to earn a survey booking rather than close a sale. The page separates the four things that actually differ between quotes — where the heat is escaping, acoustic versus thermal glazing, the lock and hinge specification, and who pays for the mess — then promises a written price that does not change on fitting day. Built for installers and home improvement contractors who lose money on surveys that were never going to convert, and want the qualifying done before the van leaves.",
      zh: "门窗更换没有什么能靠照片诚实报价，所以 Northgate 的目标是拿到一次上门测量，而不是当场成交。页面把各家报价真正的差异拆成四件事——热到底从哪里跑掉、隔音玻璃与隔热玻璃不是一回事、锁具与铰链规格、以及拆下来的垃圾谁负责——再承诺一个装修当天不会变的书面价格。适合被无效上门拖垮利润的门窗安装商与家装施工方——他们需要的是在派车之前就完成资格筛选。",
    },
    thumbnail: "https://images.unsplash.com/photo-1751486403820-7cf45ebec080?auto=format&fit=crop&w=1600&q=80",
    tier: "t2",
    tags: { category: "home-improvement", subcategory: "windows-doors", archetype: "consult", conversion: ["form", "phone"], risk: "medium", tone: "rational" },
  },
  {
    id: "home-cleaning",
  ...
  },
  {
    ...
    seoIntro: {
      ...
      zh: "设备采购是以月计的评估过程，所以 Axelon 的目标是尽早进入候选名单，而不是在页面上成交。需求表单收集工程师可据以报价的产能、公差与场地限制，跨境时还要加上电压与频率制式、以及当地认证——这几项决定设备到了现场能不能通电。「用你的物料实际试机」「明示易损件供应时效」「含安装培训」，回答工厂负责人在投入设备资金前真正衡量的问题。适合包装、加工与产线设备厂商投放 Meta / LinkedIn，承接带明确产能要求的询盘而非泛泛的样本索取。",
    },
  ...
  // ---------------------------------------------------------------------
  {
    ...
    seoIntro: {
      en: "Hair restoration has earned its scepticism through overselling, so Meridian answers it with specifics rather than with results imagery. The on-page form asks for named photo angles and returns a written graft range and technique recommendation, with an explicit willingness to advise against surgery when the case does not warrant it. Built for hair restoration clinics and the medical travel operators that place patients with them, where the assessment — not the booking — is what has to be earned first.",
      zh: "植发行业的信任问题是过度销售换来的，所以 Meridian 用具体信息而不是效果图来回应。页内表单按指定角度收集照片，回给一份书面的移植量区间与术式建议，并明确写出「不合适就劝你别做」。适合植发诊所，以及为其输送患者的医疗旅游机构——在这里要先赢得的是评估，而不是预约。",
    },
    thumbnail: "https://images.unsplash.com/photo-1758691463198-dc663b8a64e4?auto=format&fit=crop&w=1600&q=80",
    tier: "t2",
  ...
  },
  {
    ...
    seoIntro: {
      ...
      zh: "医美效果因人而异，所以 Aurelle 卖的是医生主导的面诊评估，而不是照着项目菜单卖疗程。「整脸评估」「产品批号可追溯」「初诊当天不做治疗」回应认真患者最在意的安全问题，同时避开疗程包价这类会导致医疗广告被拒的促销语义。接跨境求美者时页面还要多答一层：整个行程要待几天、要复诊几次、回国之后由谁跟进。适合靠临床判断而非折扣竞争的诊所投放。",
    },
    thumbnail: "https://images.unsplash.com/photo-1648775507324-b48dd3791fa5?auto=format&fit=crop&w=1600&q=80",
    tier: "t2",
  ...
  },
  {
    ...
    thumbnail: "https://images.unsplash.com/photo-1685012107474-4f410308805f?auto=format&fit=crop&w=1600&q=80",
    tier: "t2",
