...
export const smartHomeDraft: LandingPageDraft = {
  ...
  // 收的是同一件事（setup plan），只是换个落点，故文案与 CTA 主题保持一致。
  leadForm: {
    enabled: true,
    title: "Prefer email? Get your setup plan here",
    description:
      "Not on WhatsApp, or would rather not message? Fill this in and our setup team will send your setup plan by email instead. Same free advice, no obligation to buy anything.",
    submitText: "Send me my setup plan",
    successMessage:
      "Thanks — our setup team will email you your setup plan shortly. Check your spam folder if it hasn't arrived.",
    fields: {
      ...
      message: {
        enabled: true,
        required: true,
        label: "Your home size and which rooms you want to start with",
      },
    },
  },
