...
export const weightMgmtDraft: LandingPageDraft = {
  ...
  // 收的是同一件事（habit check），只是换个落点，故文案与 CTA 主题保持一致。
  leadForm: {
    enabled: true,
    title: "Prefer email? Get your habit check here",
    description:
      "Not on WhatsApp, or would rather not message? Fill this in and a wellness adviser will send your habit check by email instead. Same free advice, no obligation to buy anything.",
    submitText: "Send me my habit check",
    successMessage:
      "Thanks — a wellness adviser will email you your habit check shortly. Check your spam folder if it hasn't arrived.",
    fields: {
      ...
      message: {
        enabled: true,
        required: true,
        label: "Your goal and what has been hardest to stick with so far",
      },
    },
  },
