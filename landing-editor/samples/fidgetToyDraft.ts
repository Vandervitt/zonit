...
export const fidgetToyDraft: LandingPageDraft = {
  ...
  // 收的是同一件事（fidget match），只是换个落点，故文案与 CTA 主题保持一致。
  leadForm: {
    enabled: true,
    title: "Prefer email? Get your fidget match here",
    description:
      "Not on WhatsApp, or would rather not message? Fill this in and our product team will send your fidget match by email instead. Same free advice, no obligation to buy anything.",
    submitText: "Send me my fidget match",
    successMessage:
      "Thanks — our product team will email you your fidget match shortly. Check your spam folder if it hasn't arrived.",
    fields: {
      ...
      message: {
        enabled: true,
        required: true,
        label: "Who it's for, their age, and whether it needs to be quiet",
      },
    },
  },
