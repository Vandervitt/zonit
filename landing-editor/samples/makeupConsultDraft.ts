...
export const makeupConsultDraft: LandingPageDraft = {
  ...
  // 收的是同一件事（shade match），只是换个落点，故文案与 CTA 主题保持一致。
  leadForm: {
    enabled: true,
    title: "Prefer email? Get your shade match here",
    description:
      "Not on WhatsApp, or would rather not message? Fill this in and a makeup artist will send your shade match by email instead. Same free advice, no obligation to buy anything.",
    submitText: "Send me my shade match",
    successMessage:
      "Thanks — a makeup artist will email you your shade match shortly. Check your spam folder if it hasn't arrived.",
    fields: {
      ...
      message: {
        enabled: true,
        required: true,
        label: "Your skin tone, undertone, and the finish you prefer",
      },
    },
  },
