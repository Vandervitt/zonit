...
export const womensHealthDraft: LandingPageDraft = {
  ...
  // 收的是同一件事（wellness check），只是换个落点，故文案与 CTA 主题保持一致。
  leadForm: {
    enabled: true,
    title: "Prefer email? Get your wellness check here",
    description:
      "Not on WhatsApp, or would rather not message? Fill this in and a wellness adviser will send your wellness check by email instead. Same free advice, no obligation to buy anything.",
    submitText: "Send me my wellness check",
    successMessage:
      "Thanks — a wellness adviser will email you your wellness check shortly. Check your spam folder if it hasn't arrived.",
    fields: {
      ...
      message: {
        enabled: true,
        required: true,
        label: "What you'd like support with, and anything you've already tried",
      },
    },
  },
