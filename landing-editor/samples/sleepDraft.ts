...
export const sleepDraft: LandingPageDraft = {
  ...
  // 收的是同一件事（sleep check），只是换个落点，故文案与 CTA 主题保持一致。
  leadForm: {
    enabled: true,
    title: "Prefer email? Get your sleep check here",
    description:
      "Not on WhatsApp, or would rather not message? Fill this in and a sleep adviser will send your sleep check by email instead. Same free advice, no obligation to buy anything.",
    submitText: "Send me my sleep check",
    successMessage:
      "Thanks — a sleep adviser will email you your sleep check shortly. Check your spam folder if it hasn't arrived.",
    fields: {
      ...
      message: {
        enabled: true,
        required: true,
        label: "Your typical bedtime, wake time, and what disrupts your sleep",
      },
    },
  },
