...
export const activewearDraft: LandingPageDraft = {
  ...
  // 收的是同一件事（fit guide），只是换个落点，故文案与 CTA 主题保持一致。
  leadForm: {
    enabled: true,
    title: "Prefer email? Get your fit guide here",
    description:
      "Not on WhatsApp, or would rather not message? Fill this in and a fit specialist will send your fit guide by email instead. Same free advice, no obligation to buy anything.",
    submitText: "Send me my fit guide",
    successMessage:
      "Thanks — a fit specialist will email you your fit guide shortly. Check your spam folder if it hasn't arrived.",
    fields: {
      ...
      message: {
        enabled: true,
        required: true,
        label: "Your usual size, your sport, and how you like the fit to feel",
      },
    },
  },
