...
export const solarHomeDraft: LandingPageDraft = {
  ...
  // 收的是同一件事（solar assessment），只是换个落点，故文案与 CTA 主题保持一致。
  leadForm: {
    enabled: true,
    title: "Prefer email? Get your solar assessment here",
    description:
      "Not on WhatsApp, or would rather not message? Fill this in and an energy adviser will send your solar assessment by email instead. Same free advice, no obligation to buy anything.",
    submitText: "Send me my solar assessment",
    successMessage:
      "Thanks — an energy adviser will email you your solar assessment shortly. Check your spam folder if it hasn't arrived.",
    fields: {
      ...
      message: {
        enabled: true,
        required: true,
        label: "Your roof type, postcode, and rough monthly electricity spend",
      },
    },
  },
