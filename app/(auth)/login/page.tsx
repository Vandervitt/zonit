    ...
    <div className="w-full max-w-sm bg-white/80 backdrop-blur-md rounded-3xl shadow-2xl p-8">
      ...
      <div className="flex flex-col gap-3 mb-6">
        <button
          ...
          className="w-full flex items-center justify-center gap-3 border border-slate-200 rounded-xl py-2.5 text-sm text-slate-700 hover:bg-slate-50 transition-colors"
        >
        ...
        <button
          onClick={() => signIn(AuthProvider.Microsoft, { callbackUrl: Routes.Home })}
          className="w-full flex items-center justify-center gap-3 border border-slate-200 rounded-xl py-2.5 text-sm text-slate-700 hover:bg-slate-50 transition-colors"
        >
        ...
        <button
          onClick={() => signIn(AuthProvider.Apple, { callbackUrl: Routes.Home })}
          className="w-full flex items-center justify-center gap-3 border border-slate-200 rounded-xl py-2.5 text-sm text-slate-700 hover:bg-slate-50 transition-colors"
        >
