  ...
  return (
    <main className="flex-1 flex flex-col overflow-auto">
      ...
      <header className="flex items-center justify-between px-6 py-4 bg-transparent">
        <h1 className="text-foreground text-2xl">Analytical board</h1>

        <div className="flex items-center gap-3">
          {/* Chart Type */}
          <button className="flex items-center gap-1.5 text-sm text-muted-foreground hover:text-foreground/80 transition-colors">
          ...
          <div className="flex items-center gap-2 bg-white/80 backdrop-blur-sm rounded-full px-4 py-2 w-48 shadow-sm">
            ...
            <input
              type="text"
              placeholder="Search"
              className="bg-transparent outline-none text-sm text-foreground/80 placeholder-muted-foreground w-full"
            />
          </div>
